...
$row = mysqli_fetch_assoc($query);
$regname1 = $row['reg'];
$query = mysqli_query($connect, "SELECT * FROM `tovar` WHERE `region` = 'Район 1' and `city` = 'Город 1' and `fas` = '$fasname1' and `tovid` = '1' and `cat` = 'Категория 1' limit 1");	
$row = mysqli_num_rows($query);
...
$row = mysqli_fetch_assoc($query);
$regname2 = $row['reg'];
$query = mysqli_query($connect, "SELECT * FROM `tovar` WHERE `region` = '$regname2' and `city` = '$city' and `fas` = '$fasname1' and `tovid` = '$tov' and `cat` = '$cat' limit 1");	
$row = mysqli_num_rows($query);
...
$row = mysqli_fetch_assoc($query);
$regname3 = $row['reg'];
$query = mysqli_query($connect, "SELECT * FROM `tovar` WHERE `region` = '$regname3' and `city` = '$city' and `fas` = '$fasname1' and `tovid` = '$tov' and `cat` = '$cat' limit 1");	
$row = mysqli_num_rows($query);
...
$row = mysqli_fetch_assoc($query);
$regname4 = $row['reg'];
$query = mysqli_query($connect, "SELECT * FROM `tovar` WHERE `region` = '$regname4' and `city` = '$city' and `fas` = '$fasname1' and `tovid` = '$tov' and `cat` = '$cat' limit 1");	
$row = mysqli_num_rows($query);
...
$row = mysqli_fetch_assoc($query);
$regname5 = $row['reg'];
$query = mysqli_query($connect, "SELECT * FROM `tovar` WHERE `region` = '$regname5' and `city` = '$city' and `fas` = '$fasname1' and `tovid` = '$tov' and `cat` = '$cat'limit 1");	
$row = mysqli_num_rows($query);
